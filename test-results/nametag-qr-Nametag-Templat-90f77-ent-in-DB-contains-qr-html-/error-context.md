...
- Name: nametag-qr.spec.js >> Nametag Template QR Code >> template html_content in DB contains {qr_html}
- Location: e2e/nametag-qr.spec.js:89:5

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at http://dev.seriusman.shop/login
Call log:
  - navigating to "http://dev.seriusman.shop/login", waiting until "load"
