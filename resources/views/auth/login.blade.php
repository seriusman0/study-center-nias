...
<div class="min-h-[80vh] flex items-center justify-center px-4">
    <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <a href="{{ route('auth.google') }}"
           class="flex items-center justify-center gap-3 w-full border rounded-xl py-3 hover:bg-gray-50 transition mb-4">
        ...
        <div class="flex items-center gap-3 my-4">
            <hr class="flex-1"><span class="text-xs text-gray-400">atau</span><hr class="flex-1">
        </div>
