...
@section('page-title', 'Jurnal Remaja Beasiswa — Progress')
...
<div class="row mb-3">
    <div class="col-md-4">
        <div class="small-box bg-info">
            <div class="inner">
                <h3>{{ $totalUsers }}</h3>
                <p>Total Pengguna Remaja Beasiswa</p>
            </div>
            <div class="icon"><i class="fas fa-users"></i></div>
            <a href="{{ route('admin.jurnal-scholarship-teenager.laporan') }}" class="small-box-footer">Lihat Laporan <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-md-4">
...
<div class="card" id="users-table">
    <div class="card-header">
        <h3 class="card-title">Pengguna Remaja Beasiswa</h3>
