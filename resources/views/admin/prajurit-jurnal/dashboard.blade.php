...
<div class="row mb-3">
    <div class="col-md-4">
        <div class="info-box" style="cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'" data-toggle="modal" data-target="#modalTopMab">
    ...
    <div class="col-md-4">
        <div class="info-box" style="cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'" data-toggle="modal" data-target="#modalTopMas">
    ...
    <div class="col-md-4">
        <div class="info-box" style="cursor: pointer; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'" data-toggle="modal" data-target="#modalTopHafalan">
...
{{-- Top MAB Modal --}}
<div class="modal fade" id="modalTopMab" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white"><i class="fas fa-trophy mr-2"></i>Peringkat MA Bersama-sama</h5>
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body p-0">
                <ul class="list-group list-group-flush">
                    @forelse($topMabList as $index => $item)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <span class="badge badge-{{ $index < 3 ? 'warning' : 'secondary' }} mr-2">{{ $index + 1 }}</span>
                                <strong>{{ $item->student->name ?? 'Unknown' }}</strong>
                            </div>
                            <span class="badge badge-info badge-pill">{{ $item->score }} pt</span>
                        </li>
                    @empty
                        <li class="list-group-item text-center text-muted py-3">Belum ada data</li>
                    @endforelse
                </ul>
            </div>
        </div>
...
{{-- Top MAS Modal --}}
<div class="modal fade" id="modalTopMas" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title text-white"><i class="fas fa-trophy mr-2"></i>Peringkat MA di Sekolah</h5>
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body p-0">
                <ul class="list-group list-group-flush">
                    @forelse($topMasList as $index => $item)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <span class="badge badge-{{ $index < 3 ? 'warning' : 'secondary' }} mr-2">{{ $index + 1 }}</span>
                                <strong>{{ $item->student->name ?? 'Unknown' }}</strong>
                            </div>
                            <span class="badge badge-success badge-pill">{{ $item->score }} pt</span>
                        </li>
                    @empty
                        <li class="list-group-item text-center text-muted py-3">Belum ada data</li>
                    @endforelse
...
{{-- Top Hafalan Modal --}}
<div class="modal fade" id="modalTopHafalan" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title text-dark"><i class="fas fa-trophy mr-2"></i>Peringkat Ayat Hafalan</h5>
                <button type="button" class="close text-dark" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body p-0">
                <ul class="list-group list-group-flush">
                    @forelse($topHafalanList as $index => $item)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <span class="badge badge-{{ $index < 3 ? 'primary' : 'secondary' }} mr-2">{{ $index + 1 }}</span>
                                <strong>{{ $item->student->name ?? 'Unknown' }}</strong>
                            </div>
                            <span class="badge badge-warning badge-pill text-dark">{{ $item->score }} pt</span>
                        </li>
                    @empty
                        <li class="list-group-item text-center text-muted py-3">Belum ada data</li>
                    @endforelse
...
function openSummaryModal(userId) {
    ...
    .then(data => {
        ...
        rows.forEach((row, i) => {
            ...
            // Parse tanggal tanpa timezone shift: tambahkan T00:00:00 agar diparse sebagai local time
