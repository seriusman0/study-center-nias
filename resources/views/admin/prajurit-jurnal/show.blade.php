...
@section('content')
<a href="{{ route('admin.jurnal-prajurit.laporan') }}" class="btn btn-sm btn-link mb-2"><i class="fas fa-arrow-left"></i> Kembali</a>
...
<div class="card">
    <div class="card-header">
        <form method="GET" class="form-inline">
            ...
            <a href="{{ route('admin.jurnal-prajurit.export', ['user' => $targetUser->id, 'from' => $from->toDateString(), 'to' => $to->toDateString()]) }}"
