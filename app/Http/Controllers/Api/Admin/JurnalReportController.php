...
class JurnalReportController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'total_today' => JurnalEntry::whereDate('tanggal', $today)->count(),
            'total_week'  => JurnalEntry::whereBetween('tanggal', [$weekStart, $today])->count(),
        ]);
    }
    ...
    public function show(Request $request, User $student): JsonResponse
    {
        ...
        return response()->json([
            'student' => $student->load('cabang:id,nama', 'studentProfile'),
