...
class ScholarshipTeenagerJurnalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('scholarship-teenager.jurnal', [
            'date'           => $date,
            'today'          => $today,
            'isToday'        => $isToday,
            'formOpen'       => $formOpen,
    ...
    public function showOther($userId, Request $request)
    {
        ...
        abort_unless($targetUser->hasRole('scholarship_teenager'), 403);
        abort_if($targetUser->id === $viewer->id, 302, route('scholarship-teenager-jurnal.index'));
